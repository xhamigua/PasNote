 ...
 * Ported by CodeCoolie@CNSW 2010/03/20 -> $Date:: 2013-02-05 #$
 *)
 ...
 *)
type
  Tav_strerrorProc = function(errnum: Integer; errbuf: PAnsiChar; errbuf_size: Cardinal): Integer; cdecl;
...
const
  CErrorList: array[0..209] of TErrorItem = (
    // av_strerror()
